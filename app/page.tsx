		...
		<div className='page'>
			<header>
				<nav>
					...
					<li><Link href="https://app.fillout.com/flow/ueioaUfgaxus" target='_blank' className='button'>Join us</Link></li>
				</nav>
			</header>
			<main>
				...
				<div className='sponsors'>
					...
					<div className="sponsors_section">
						...
						<div className="support_link">
							<Link href='https://bank.hackclub.com/donations/start/morncast' target='_blank'>
								You? Support us
							</Link>
						</div>
					</div>
