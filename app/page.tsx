	...
	return (
		<div className='page'>
			<header>
				<nav>
					...
					<div className='nav'>
                    <li><Link href="#" target='_blank' className='button t1'>{days} {'d'} {hours} {'h'} {minutes} {'m'} {seconds} {'s'}</Link></li>
			...
			<main>
				...
				<div>
					<Image alt="" src="/humans.svg"   width='200' height='207' className='image2'  priority={true} />
				</div>
				<div className='main'>
					<div
                    ...
                    <div id="spots-container">
                        <div className="blob green" aria-hidden="true"></div>
                        <h2 id="header-subtitle-spots">284 spots remaining</h2>
                    </div>
	 ...
	 <article id='event-description'>
                    ...
                    <div id="event-main-box">
                        <div id="description-content">Morncast Community is a student-led organization focused on promoting community engagement and improving TECH exposure for local high school students.</div>
					...
					<div id="timeline">
                        ...
                        <div className="flex-parent">
                            <div className="input-flex-container">
                                <input id="t1" className="timeline-input" type="radio" name="timeline-dot" data-description="1" defaultChecked/>
                                <div onClick={()=> "check('t1')"} className="dot-info" data-description="1">
                                    <span className="year">7/28 9:00am</span>
                                    <span className="label">Opening Ceremony</span>
                                </div>
                                <input id="t2" className="timeline-input" type="radio" name="timeline-dot" data-description="2"/>
                                <div onClick={()=> "check('t2')"} className="dot-info" data-description="2">
                                    <span className="year">7/28 10:00am</span>
                                    <span className="label">Hacking Begins</span>
                                </div>
                                <input id="t3" className="timeline-input" type="radio" name="timeline-dot" data-description="3"/>
                                <div onClick={()=> "check('t3')"} className="dot-info" data-description="3">
                                    <span className="year">7/28 8:00pm</span>
                                    <span className="label">Projects Due</span>
                                </div>
                                <input id="t4" className="timeline-input" type="radio" name="timeline-dot" data-description="4"/>
                                <div onClick={()=> "check('t4')"} className="dot-info" data-description="4">
                                    <span className="year">7/28 9:00pm</span>
                                    <span className="label">Project Presentations</span>
                                </div>
                                <input id="t5" className="timeline-input" type="radio" name="timeline-dot" data-description="5"/>
                                <div onClick={()=> "check('t5')"} className="dot-info" data-description="5">
                                    <span className="year">12/28 10:00pm</span>
                                    <span className="label">Awards Ceremony</span>
                                </div>
                        
                                <div id="timeline-descriptions-wrapper">
                                    <div className="timeline-desc" data-description="1">
                                        <div className="bracket" id="bracket-1">
                                    ...
                                    <div className="timeline-desc" data-description="2">
                                        <div className="bracket" id="bracket-2">
                                            <div className="left"></div>
                                            <div className="right"></div>
                                        </div>
                                        <h3>Hacking Begins</h3>
                                        <h4 className="timeline-description-subtitle">7/28 | 10:00am</h4><br/>
                                        <p className="timeline-description">
                                         {"Now's your time to shine! Start working with your team to build your project. No strings attached!"}
                                         <ul className="timeline-description-list">
                                                <li><span className="important-text">=IMPORTANT=</span> Your project must follow one of the given prompts and guidelines; otherwise, your team may lose a lot of points for unrelated topic deductions</li>
                                                <li>Remember use your time wisely</li>
                                            </ul>
                                        </p>
                                    </div>
                                    <div className="timeline-desc" data-description="3">
                                        <div className="bracket" id="bracket-3">
                                            <div className="left"></div>
                                            <div className="right"></div>
                                        </div>
                                        <h3>Projects Due</h3>
                                        <h4 className="timeline-description-subtitle">7/28 | 8:00pm</h4><br/>
									    <p className="timeline-description">STOP coding! intense stress and turmoil are finally up! We hope you learned some valuable skills and made some new friends along the way.
                                            <ul className="timeline-description-list">
                                                <li><span className="important-text">=IMPORTANT=</span> Make sure you turn in your project BEFORE the deadline at 8:00pm. You can submit using our github
                                                <Link href='https://github.com/Morncast' className="link" target='_blank'> Morncast Community</Link>
                                                </li>
                                                <li>{"Don't leave yet though, because you still need to present your project to the judges"}</li>
                                                <li>From now until Project Presentations (8:30pm), your team will have around 30 mins to prepare for your presentation. Get back to work!</li>
                                            </ul>
                                        </p>
                                    </div>
                                    <div className="timeline-desc" data-description="4">
                                        <div className="bracket" id="bracket-4">
                                            <div className="left"></div>
                                            <div className="right"></div>
                                        </div>
                                        <h3>Project Presentations</h3>
                                        <h4 className="timeline-description-subtitle">7/28 | 8:30pm - 9:30pm</h4><br/>
                                        <p className="timeline-description">This is where your team will present your product to our honored judges.<br/>
                                            <ul className="timeline-description-list">
                                                ...
                                                <li><span className="important-text">=IMPORTANT=</span>{"Your team's presentation is NOT ALLOWED to go above 5 minutes... Use your time wisely."}</li>
                                                <li>Your team will be graded on both the product and presentation as per the rubric</li>
                                            </ul>
                                        </p>
                                    </div>
                                    <div className="timeline-desc" data-description="5">
                                        <div className="bracket" id="bracket-5">
                                            <div className="left"></div>
                                            <div className="right"></div>
                                        </div>
